...
sum(tabDNA[1,]) * tabDNA[1,2]/sum(tabDNA[1,]) # n1p1
sum(tabDNA[1,]) * (1- (tabDNA[1,2]/sum(tabDNA[1,]))) # n1q1
sum(tabDNA[2,]) * tabDNA[2,2]/sum(tabDNA[2,]) # n2p2
sum(tabDNA[2,]) * (1- (tabDNA[2,2]/sum(tabDNA[2,]))) # n2q2
```
